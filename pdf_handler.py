...
def generate_pdf(celeb, say_what, target_language, temperature, top_k, top_p, response, image_path):
    ...
    - `image_path`: The file path of the image to be added to the PDF.
...
if __name__ == "__main__":
    ...
    pdf_path = generate_pdf(celeb, say_what, target_language,
                            ...
                            response, image_path="./static/qr/qr.png")
